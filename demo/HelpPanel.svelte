...
引き分け</code></pre>
    ...
    <section id="help-faq">
      ...
      <p>Horkewの推理エンジンは、<strong>COされていない役職を非CO処刑者に割り当てない</strong>というルールで動作しています。つまり、役職COせずに処刑された人は村人系役職（占い師・霊媒師・狩人など）ではないと判定されます。</p>
      <p>これは「占い師が潜伏している」「狩人が黙って吊られた」といった可能性を意図的に除外するものです。</p>
      <p>理由は以下の通りです:</p>
      <ul>
        <li><strong>潜伏を考慮すると推理が成立しない</strong> — 「誰でも何かの役職を隠しているかもしれない」という仮定を入れると、ほぼすべての絞り込みが無効化され、ツールとしての推理支援が機能しなくなります。</li>
        <li><strong>実戦のセオリーに沿った設計</strong> — 一般的な人狼のセオリーでは、占い師や狩人などの重要役職は適切なタイミングでCOすることが基本です。特に処刑対象になった場合にCOせず黙って吊られることは通常想定されません。Horkewはこのセオリーを前提として推理を組み立てます。</li>
      </ul>
    </section>
  </div>
</aside>
